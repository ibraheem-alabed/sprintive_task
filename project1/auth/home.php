...
function getLoggedInUserName()
{
    if (isset($_SESSION['user'])) {
        return $_SESSION['user']['display_name']; // Modify this line to retrieve the username from the session variable
    }
...
$directory = 'file/'.$loggedInUsername .'/';
...
$userFolderPath = $directory . $loggedInUsername . '/';
...
// Get the logged-in user's name (replace 'username' with the actual variable or function to retrieve the user's name)
$loggedInUsername = getLoggedInUserName(); // Assuming you have a function to get the logged-in user's name
